...
namespace Code.All_user_control
{
    public partial class UC_RentRoom : UserControl
    {
        ...
        private void UC_RentRoom_Leave(object sender, EventArgs e)
        {

        }

        private void UC_RentRoom_Enter(object sender, EventArgs e)
        {
            UC_RentRoom_Load(this, null);
        }

        private void btnRentRoom_Click_1(object sender, EventArgs e)
        {
            ...
            if (txtCusName.Text != "" && txtCusCMND.Text != "" && txtRoomType.Text != "" && txtRoomNo.Text != "" && txtCheckOut.Text != "" && txtCheckIn.Text != "" && txtNumberCus.Text != "")
            {
                ...
                else
                {
                    ...
                    string cmnd = txtCusCMND.Text;  // Lấy CMND dưới dạng chuỗi
                    String addr;
                    String phonenumber;
                    String Sex = "Khác";
                    String cusType = "";
